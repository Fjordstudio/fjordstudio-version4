...
?>
    ...
    <ul class="frontpage-menu">
      <li>
        <a href="/jeg-arbejder-med-design-og-kode/">
...
*/
   ...
   while ( $loop->have_posts() ) : $loop->the_post();
    ...
    ?>
      <div class="priority">
      <article id="post-<?php get_the_ID(); ?>" style="background-image:url('<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>');">
